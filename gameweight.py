...
class Gamewiget(QWidget):
    ...
    def initui(self):
        ...
        # 悔棋按钮
        self.regret_button = MyButton('source/悔棋按钮_hover.png', 'source/悔棋按钮_normal.png', 'source/悔棋按钮_press.png',
                                      parent=self)
    ...
    def mouseReleaseEvent(self, a0: QtGui.QMouseEvent):
        ...
        position = self.reverse_to_positon(coordinate=a0)
    ...
    # 将鼠标点击坐标转化为棋盘交点坐标
    def reverse_to_positon(self, coordinate):
        coor_x = coordinate.x()
        coor_y = coordinate.y()
    ...
    def down_chess(self, position, color):
        ...
        chessman.show()
        # 添加落子声音
        QSound.play('source/niganma.wav')
        # 显示最新的落子标识
